...
function SignUp() {
  ...
  const createAccount = async (data) => {
    ...
    if (!selectedOptions.company || !selectedOptions.work || !selectedOptions.role) {
        ...
        <div className="p-8">
          ...
          <form className="flex flex-col" onSubmit={handleSubmit(createAccount)}>
            ...
            {step === 2 && (
              <>
                <div className="mb-4">
                  ...
                  <select className="w-full p-2 border rounded" {...register("city", { required: "City is required" })}>
                    ...
                    {["Product Based", "Service Based"].map((company) => (
                      <button
                        ...
                        className={`px-4 py-2 border rounded-full ${
                          selectedOptions.company === company ? "bg-blue-600 text-white" : "bg-gray-100 hover:bg-gray-200"
                        }`}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Technical", "Designing", "Research", "Marketing"].map((field) => (
                      <button
                        ...
                        type="button"
                        className={`px-4 py-2 border rounded-full ${
                          selectedOptions.work === field ? "bg-blue-600 text-white" : "bg-gray-100 hover:bg-gray-200"
                        }`}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Intern", "Full Time", "Work from Home", "Work from Office", "Hybrid"].map((role) => (
                      <button
                        ...
                        type="button"
                        className={`px-4 py-2 border rounded-full ${
                          selectedOptions.role === role ? "bg-blue-600 text-white" : "bg-gray-100 hover:bg-gray-200"
                        }`}
                ...
                <Input label="Address" placeholder="Company Address" type="text" {...register("address", { required: "Address is required" })} />
            ...
            <div className="flex justify-between">
              {step > 1 && (
                <Button type="button" className="bg-gray-300 text-gray-800 py-2 px-4 rounded" onClick={prevStep}>
                  Previous
                </Button>
              )}
              {step < 2 ? (
                <Button type="button" className="bg-blue-600 text-white py-2 px-4 rounded" onClick={nextStep}>
                  Next
                </Button>
              ) : (
